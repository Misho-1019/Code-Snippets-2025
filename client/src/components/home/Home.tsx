        ...
        <main className="bg-gray-50 min-h-screen py-16 px-6">
            <div className="max-w-4xl mx-auto text-center">
                ...
                <div className="flex justify-center gap-4 mb-12">
                    <button onClick={() => navigate('/snippets')} className="bg-indigo-600 text-white px-6 py-2 rounded-full hover:bg-indigo-700 transition">
                        Get Started
                    </button>
                    <button onClick={scrollToLatest} className="bg-white border border-indigo-600 text-indigo-600 px-6 py-2 rounded-full hover:bg-indigo-50 transition">
                        Learn More
                    </button>
                </div>

                <h3 id="latest-snippets" className="text-2xl font-bold text-gray-700 mb-6">Latest Snippets</h3>
